      ...
      <div className="container mx-auto px-6">
        ...
        >
          <motion.div variants={revealUp} className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="text-4xl font-black md:text-5xl">Technical Capabilities</h2>
            <p className="mt-4 text-lg text-muted-foreground">
              Tools and methods applied across software engineering, security analysis, data workflows, and IT support.
            </p>
          </motion.div>
          ...
          >
            {skillCategories.map((category) => {
              ...
              return (
                <motion.div key={category.title} variants={cardReveal} whileHover={{ y: -4 }}>
